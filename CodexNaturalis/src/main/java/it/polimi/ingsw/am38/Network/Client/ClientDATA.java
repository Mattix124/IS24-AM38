...
public class ClientDATA
{
	...
	public void buildGoldCards()
	{
		...
		{ // for each element in the json file
			...
			goldCard = new GoldCard(ID, kingdom, imgFront, imgBack, condPointType, pointGiven, FNW, FNE, FSW, FSE, BNW, BNE, BSW, BSE, first, second, third, fourth, fifth);  //create the gold card to be inserted in the ArrayList
	...
	public void buildResourceDeck()
	{
		...
		{ // for each element in the json file
			...
			resourceCard = new ResourceCard(ID, kingdom, imgFront, imgBack, pointGiven, FNW, FNE, FSW, FSE, BNW, BNE, BSW, BSE);  //create the resource card to be inserted in the deck
	...
	public void buildObjectiveDeck()
	{
		...
		{ // for each element in the json file
			...
			switch (objType)
			{
				...
				case "all" ->
						objectiveCard = new ObjectiveCard(ID, "null", objType, imgFront, imgBack, pointGiven, "null", "null", "null");
			}
	...
	/**
	 * Getter of the list of nicknames
	 *
	...
	/**
	 * Set the list of players nicknames
	 * @param playersToAdd the list of nickname
	 */
