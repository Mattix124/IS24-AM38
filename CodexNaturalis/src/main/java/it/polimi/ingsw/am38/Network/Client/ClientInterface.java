...
public interface ClientInterface extends Remote, Serializable
{
	 ...
	 *
	 * @param playersInfo HashMap of String, PlayerDisconnectionResendInfo , key: nickname of all players, value: all available information about each Player
	 * @param ownHand List of PlayableCard containing all 3 cards in the Player's hand
